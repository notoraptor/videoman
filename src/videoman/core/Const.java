...
public class Const {
	...
	static public final int DAYS = 0;
	static public final int HOURS = 1;
	static public final int MINUTES = 2;
	static public final int SECONDS = 3;
	static public final int DURATION_COUNT = 4;
	static public final String[] durationNames = new String[]{"j", "h", "min", "sec"};
